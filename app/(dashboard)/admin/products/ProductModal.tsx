...
function ProductModal({ isOpen, onClose, onSave, product }: ProductModalProps) {
    ...
    const updateVariant = (index: number, field: 'name' | 'price', value: string | number | null) => {
        const currentVariants = [...(formData.variants || [])];

        let processedValue = value;
        if (field === 'price') {
            processedValue = (value === '' || value === null) ? null : parseFloat(value as string);
        }

        currentVariants[index] = { ...currentVariants[index], [field]: processedValue };
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                min="0"
                                                step="0.01"
                                                value={formData.discountPrice === undefined || formData.discountPrice === null ? '' : formData.discountPrice}
